...
/**
 * @title TestnetMorphoAdapter
 * @notice Simplified Morpho adapter for Base Sepolia testnet
 * @dev Mock implementation for testing purposes without requiring actual Morpho deployment
 */
contract TestnetMorphoAdapter is IProtocolAdapter, Ownable {
    ...
    /// @notice Mock APY (7% for testing)
    uint256 private constant MOCK_APY = 700; // 7.00% in basis points
