...
/**
 * @title TestnetMoonwellAdapter
 * @notice Simplified Moonwell adapter for Base Sepolia testnet
 * @dev Mock implementation for testing purposes without requiring actual Moonwell deployment
 */
contract TestnetMoonwellAdapter is IProtocolAdapter, Ownable {
    ...
    /// @notice Mock APY (6% for testing)
    uint256 private constant MOCK_APY = 600; // 6.00% in basis points
